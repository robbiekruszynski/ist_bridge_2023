...
// const FromCard = (props,{ isLoading }) => {

//   const theme = useTheme();

//   //const defaultSelectState = (props.location == 'from') ? 'polygonzkevm' : 'zksyncera';

//   const [chain, setChain] = useState(props.chain);
//   // const [sectionColors, setColors] = useState(Networks()[defaultSelectState].colors);
...
//         <SkeletonEarningCard />
//       ) : (
//         <CardWrapper id="from-card" className={chain} border={false} content={false}>
//           <Box sx={{ p: 2.25 }}>
//             <Grid container direction="column">
//               <Grid item>
//                 <Grid container justifyContent="space-between">
...
//                     <ChainSelect updateChain={updateChain} chain={chain} location="from" networks={networks} />
...
//                     <style>{textFieldInlineStyle}</style>
//                         {/* mt was previously 1.75 */}
//                         <TextField onChange={handleAmountChange} id="from-amount" type="number" inputProps={{ inputMode: 'numeric', pattern: '[0-9]*' }} sx={{ fontSize: '2.125rem', fontWeight: 500, mr: 1, mt: 1, mb: 0.75 }} placeholder="0.000" variant="standard" />
