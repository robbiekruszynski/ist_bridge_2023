...
//   // };
//   const updateChain = (thisChain) => {

//     // console.log(thisChain);

//     setChain((thisChain) => thisChain);
//     props.updateChain(thisChain);
   
//     // console.log(chain);
//     // setColors((chain) => Networks()[chain].colors)
//     // console.log('colors');
...
// // const [setCurrencyAmount] = useState(null);
...
// //   };
//     const textFieldInlineStyle = "#to-amount,#to-amount::placeholder{text-align:right;font-size: 2.125rem; font-weight: 500; margin-right: 8px; margin-top: 14px; margin-bottom: 6px; color: #fff; margin: 0; border-color: rgba(255,255,255,0.8);} #to-amount-container .MuiInputBase-formControl:before {border-color:rgba(255,255,255,0.8)} #to-amount-container .MuiInput-underline:after{border-color:#fff}/* Hide number arrows - Chrome, Safari, Edge, Opera */ #to-amount::-webkit-outer-spin-button, #to-amount::-webkit-inner-spin-button { -webkit-appearance: none; margin: 0; } /* Hide number arrows - Firefox */ #to-amount[type=number] { -moz-appearance: textfield; }";
//     const addresstextFieldInlineStyle = `#to-address, #to-address::placeholder {color: ${theme.palette.primary[200]}; font-weight: 500; font-size: 1rem; padding-top: 0; padding-bottom: 0;} #to-address-container .MuiInput-underline:before{ border-color: ${theme.palette.primary[200]};} #to-address-container .MuiInput-underline:after{border-color:${theme.palette.primary[200]}}`;
...
//         <SkeletonEarningCard />
//       ) : (
//         <CardWrapper id="to-card" className={chain} border={false} content={false}>
//           <Box sx={{ p: 2.25 }}>
//             <Grid container direction="column">
//               <Grid item>
//                 <Grid container justifyContent="space-between">
...
//                     <ChainSelect updateChain={updateChain} chain={chain} location="to" />
...
//                     <style>{textFieldInlineStyle}</style>
//                     {/* mt was previously 1.75 */}
//                     <TextField onChange={handleAmountChange} type="number" inputProps={{ inputMode: 'numeric', pattern: '[0-9]*' }} id="to-amount" sx={{ fontSize: '2.125rem', fontWeight: 500, mr: 1, mt: 1, mb: 0.75 }} placeholder="0.000" variant="standard" />
//                   </Grid>
//                   <Grid item>
//                     {/* mt was previously 1.75 */}
//                     <Typography id="to-currency" sx={{ fontSize: '2.125rem', fontWeight: 500, mr: 1, mt: 1, mb: 0.75}}>ETH</Typography>
